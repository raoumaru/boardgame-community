        ...
        <div className="mx-auto max-w-lg">
          ...
          <div className="mb-5 flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-3">
              {/* LINEシェア */}
              <a
                href={`https://line.me/R/share?text=${encodeURIComponent(`私のボドゲMBTIは${result.code}「${typeData.name}」でした！「${typeData.catchcopy}」\nhttps://www.boardgame-raou.com/mbti/${result.code.toLowerCase()}`)}`}
                target="_blank"
