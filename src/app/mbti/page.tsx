...
import { Dna, RotateCcw, ThumbsUp, Zap, ImageDown } from 'lucide-react'
        ...
        <div className="mx-auto max-w-lg">
          ...
          <div className="mb-5 flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-3">
              {/* LINEシェア（画像付き） */}
              <button
                onClick={() => handleLineShare(result.code, typeData.name, typeData.catchcopy, axisLabels, typeData.image)}
                disabled={lineSharing}
                className="inline-flex items-center gap-2 rounded-full border border-[#06C755]/40 bg-[#06C755]/15 px-5 py-2 text-xs font-bold text-[#06C755] transition-all hover:bg-[#06C755]/25 disabled:opacity-50"
              >
            ...
            {shareErrorMsg && (
              <p className="mt-1 text-[10px] text-red-400">{shareErrorMsg}</p>
            )}
          </div>
